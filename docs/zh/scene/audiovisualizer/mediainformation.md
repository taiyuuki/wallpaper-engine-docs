...
You can also access album cover colors through the [mediaThumbnailChanged](/zh/scene/scenescript/reference/event/media.html) event, specifically the [MediaThumbnailEvent](/zh/scene/scenescript/reference/class/MediaThumbnailEvent.md) class that is provided as a function parameter.
...
* [SceneScript Media Events](/zh/scene/scenescript/reference/event/media.html)
